...
class PasskeysWeb extends PasskeysPlatform {
  ...
  static void registerWith([Object? registrar]) {
    ...
    // Nunca window.close() (iPhone PWA → pantalla blanca).
    // init() puede lanzar si falta el SDK JS; no tumbar el arranque.
    try {
      init();
    } catch (e) {
      debugPrint('Passkeys Web SDK no disponible (boot continúa): $e');
    }
  }
